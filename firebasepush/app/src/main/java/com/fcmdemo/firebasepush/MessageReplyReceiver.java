...
import com.fcmdemo.firebasepush.service.FirebaseMessageService;
...
public class MessageReplyReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (FirebaseMessageService.REPLY_ACTION.equals(intent.getAction())) {
            int conversationId = intent.getIntExtra(FirebaseMessageService.CONVERSATION_ID, -1);
    ...
    private CharSequence getMessageText(Intent intent) {
        ...
        if (remoteInput != null) {
            return remoteInput.getCharSequence(
                    FirebaseMessageService.EXTRA_REMOTE_REPLY);
        }
        return null;
    }
}
